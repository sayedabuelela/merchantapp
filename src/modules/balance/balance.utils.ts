...
export const getActivityInfoMessage = (type: ActivityType, t: (key: string) => string): string => {
    switch (type) {
        ...
        case 'upcoming_balance':
            return t('These funds are being processed and will become available once settlement is complete. Settlement typically takes 1-3 business days depending on the transaction type.');
        default:
            return '';
    }
};