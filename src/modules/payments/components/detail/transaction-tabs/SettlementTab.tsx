...
import CurrencyConversionSection from '@/src/modules/payments/components/detail/settlement/sections/CurrencyConversionSection';
...
const SettlementTab = ({ transaction }: Props) => {
    ...
    return (
        <>
            {/* Renders nothing unless the transaction is virtual-origin */}
            <CurrencyConversionSection amount={transaction.amount} virtual={transaction.order?.virtualTransaction} />
            {renderMethodSettlement()}
        </>
    );
};
