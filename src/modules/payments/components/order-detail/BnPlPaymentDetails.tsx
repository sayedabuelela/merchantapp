...
import { MasterCardIcon, NBEIcon, VisaIcon, AmanSettlementIcon, ValuIcon, SouhoolaSettlementIcon, ContactSettlementIcon, MogoIcon, } from '@/src/shared/assets/svgs';
...
const getMethodIcon = (method: PaymentMethod) => {
    switch (method) {
        ...
        case 'mogo':
            return <View className="ml-auto"><MogoIcon height={40} width={70} /></View>;
        default:
            return null;
    }
};
        ...
        <View className="bg-[#F1F6FF] border border-[#D9E5FF] p-6 mt-4 rounded ">
            <View className="flex-row items-center justify-between">
                <View className="flex-row items-center gap-x-1">
                    ...
                    {paymentChannel && (<FontText type="body" weight="semi"
