...
/**
 * Checks if payment is specifically a Tru BNPL payment
 * Used to route to Tru-specific settlement details
 */
export const isTruBnplPayment = (sourceOfFunds?: SourceOfFunds): boolean => {
    if (!sourceOfFunds) return false;
